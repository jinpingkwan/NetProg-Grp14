...
| CLI Command | Playbook | Extra Vars |
|---|---|---|
| `netauto configure ip <host> --ip <addr> --mask <mask>` | `playbooks/configure_ip.yml` | `target_host`, `ip_address`, `subnet_mask` |
...
netauto configure interface router1 --iface Gi0/1 --desc "Uplink to core"
